...
async function initDatabase() {
  try {
    ...
    const migrations = [
      ...
      `ALTER TABLE tokens MODIFY COLUMN x FLOAT DEFAULT 0`,
      `ALTER TABLE tokens MODIFY COLUMN y FLOAT DEFAULT 0`,
      `ALTER TABLE tokens ADD COLUMN IF NOT EXISTS hp INT DEFAULT NULL`,
      `ALTER TABLE tokens ADD COLUMN IF NOT EXISTS max_hp INT DEFAULT NULL`,
